package Array_Questions.Merge_Two_Sorted_Array_In_New_Array_In_Sorted_Order;

import java.util.Arrays;

public class Soluiton1 {
    public static void main(String[] args) {
        int[] arr1={1,2,23,44,53,440};
        int[] arr2={1,2,3,4,5,666};
        int arr1Length=arr1.length;
        int arr2Length=arr2.length;
        int[] arr3 = new int[arr1Length+arr2Length];
        int arr1Index=0,arr2Index=0,arr3Index=0;

        while (arr1Index<arr1Length && arr2Index<arr1Length){
